...
from alce.utils import normalize_answer, get_max_memory, remove_citations

QA_MODEL = "/home/models/roberta-large-squad"  # "gaotianyu1350/roberta-large-squad"
AUTOAIS_MODEL = "/home/models/t5_xxl_true_nli_mixture"
...
def compute_qa(data):
    ...
    qa_pipeline = pipeline("question-answering", model=QA_MODEL, device_map="auto")
    logger.info("Done")
...
def compute_mauve(data):
    ...
    out = mauve.compute_mauve(
        ...
        verbose=True,
        batch_size=8,
        featurize_model_name="/home/models/gpt2-large",
    )
