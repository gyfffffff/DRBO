...
from remax.utils.utils import print_rank_0
...
class ReMaxTrainer:
    def __init__(self, rlhf_engine, args):
        ...
        self.args = args
        self.max_answer_seq_len = args.max_new_tokens
    ...
    def step(
        ...
        actor_loss, actor_return, kl_ratio = self.compute_loss(exp_data)
        return actor_loss
...
class ReMaxTrainerUnsupervised(ReMaxTrainer):
